...
import keyboard
from enhanced_selenium._models._core.debug_finder import DebugFinder
from enhanced_selenium._models._core.findable_element import Element, Findable
from enhanced_selenium._models.context import _NoError, _RepeatSetting
from enhanced_selenium._utils.date_parser import parse_date
...
class EnhancedChrome(webdriver.Chrome, Findable):
    ...
    def no_error(self):
        ...
        Returns:
            _NoError: 예외 무시 객체. -> with 구문으로 사용
    ...
    def set_retry(self, timeout: float | None = None, freq: float | None = None):
        ...
        Returns:
            _RepeatSetting: 재시도 설정 객체. -> with 구문으로 사용 가능
